(function(){
  ...
  var brandColor = normalizeHexColor(config.brandColor) || detectBrandColor() || '#2a341e';
  var brandRgbTriplet = hexToRgbTriplet(brandColor) || '42,52,30';
  ...
  function scopedSelectors(scope, selectors){
    return selectors.split(',').map(function(selector){ return scope+' '+selector; }).join(',');
  }
  function injectPreflightStyle(){
    ...
    style.textContent = [
      ...
      scopedSelectors('html[data-yd-lala-active-tab="qna"]', detailPaneCssSelector+','+reviewPaneCssSelector)+'{display:none!important}',
      ...
      'html[data-yd-lala-active-tab="review"] .detail_review_wrap > :not(#yd-review-inline-system),html[data-yd-lala-active-tab="review"] .detail_review_wrap_mobile > :not(#yd-review-inline-system),html[data-yd-lala-active-tab="review"] #first_review > :not(#yd-review-inline-system),html[data-yd-lala-active-tab="review"] ._detail_review_wrap > :not(#yd-review-inline-system),html[data-yd-lala-active-tab="review"] ._detail_review_wrap_mobile > :not(#yd-review-inline-system),body[data-yd-lala-active-tab="review"] .detail_review_wrap > :not(#yd-review-inline-system),body[data-yd-lala-active-tab="review"] .detail_review_wrap_mobile > :not(#yd-review-inline-system),body[data-yd-lala-active-tab="review"] #first_review > :not(#yd-review-inline-system),body[data-yd-lala-active-tab="review"] ._detail_review_wrap > :not(#yd-review-inline-system),body[data-yd-lala-active-tab="review"] ._detail_review_wrap_mobile > :not(#yd-review-inline-system){display:none!important}',
      'html[data-yd-lala-active-tab="review"] #yd-review-inline-system,body[data-yd-lala-active-tab="review"] #yd-review-inline-system{display:block!important}',
      ...
      '._prod_detail_tab_fixed li.prod_tab_3,#fixed_tab li.prod_tab_3,#fixed_tab_mobile li.prod_tab_3{position:relative!important;min-width:33.333%!important;text-align:center!important}',
      '._prod_detail_tab_fixed li.prod_tab_3:before,._prod_detail_tab_fixed li.prod_tab_3:after,#fixed_tab li.prod_tab_3:before,#fixed_tab li.prod_tab_3:after,#fixed_tab_mobile li.prod_tab_3:before,#fixed_tab_mobile li.prod_tab_3:after,._prod_detail_tab_fixed li.prod_tab_3>a:after,#fixed_tab li.prod_tab_3>a:after,#fixed_tab_mobile li.prod_tab_3>a:after{display:none!important;content:none!important}',
      '._prod_detail_tab_fixed .site_prod_nav,#fixed_tab .site_prod_nav,#fixed_tab_mobile .site_prod_nav{position:relative!important}',
      '._prod_detail_tab_fixed .site_prod_nav:before,#fixed_tab .site_prod_nav:before,#fixed_tab_mobile .site_prod_nav:before{content:"|"!important;display:block!important;position:absolute!important;left:33.333%!important;top:50%!important;color:#191d24!important;font-size:14px!important;line-height:1!important;font-weight:400!important;transform:translate(-50%,-50%)!important;opacity:1!important;z-index:5!important;pointer-events:none!important}',
      '._prod_detail_tab_fixed .site_prod_nav:after,#fixed_tab .site_prod_nav:after,#fixed_tab_mobile .site_prod_nav:after{content:"|"!important;display:block!important;position:absolute!important;left:66.666%!important;top:50%!important;color:#191d24!important;font-size:14px!important;line-height:1!important;font-weight:400!important;transform:translate(-50%,-50%)!important;opacity:1!important;z-index:5!important;pointer-events:none!important}',
  ...
  function rgbToHex(value){
    ...
    return '#'+[match[1], match[2], match[3]].map(function(part){
      var hex = Math.max(0, Math.min(255, Number(part) || 0)).toString(16);
  ...
  function nativeTabPaneSelectors(kind){
    return {
      detail: detailPaneCssSelector,
      review: '.detail_review_wrap,.detail_review_wrap_mobile,#first_review,._detail_review_wrap,._detail_review_wrap_mobile',
      qna: '.detail_qna_wrap,.detail_qna_wrap_mobile,#first_qna,._detail_qna_wrap,._detail_qna_wrap_mobile'
    }[kind] || '';
  }
  ...
  function syncNativeTabActiveClasses(){
    Array.prototype.forEach.call(document.querySelectorAll('a._detail, a._review, a._qna'), function(anchor){
      ...
      anchor.style.setProperty('color', isActive ? brandColor : '#191d24', 'important');
  ...
  function injectStyle(){
    ...
    style.textContent = [
      ...
      '.yd-lala-tabs-normalized .site_prod_nav{position:relative!important}',
      '.yd-lala-tabs-normalized .prod_tab_3:before,.yd-lala-tabs-normalized .prod_tab_3:after,.yd-lala-tabs-normalized .prod_tab_3 > a:after{display:none!important;content:none!important}',
      '.yd-lala-tabs-normalized .site_prod_nav:before{content:"|"!important;display:block!important;position:absolute!important;left:33.333%!important;top:50%!important;color:#191d24!important;font-size:14px!important;line-height:1!important;font-weight:400!important;transform:translate(-50%,-50%)!important;opacity:1!important;z-index:5!important;pointer-events:none!important}',
  ...
  var nativeTabPreviewKey = '';
  var nativeTabPreviewAt = 0;
  ...
  function bindNativeReviewTabLinks(){
    ...
    function reinforceNativeTabState(kind, shouldScroll){
      ...
      [80, 220, 520].forEach(function(delay){
        scheduleNativeTabReinforcement(kind, delay, epoch);
      });
    }
    function previewNativeTab(ev){
      var kind = nativeTabKindFromTrigger(ev.target);
      if (!kind) return;
      var now = Date.now();
      var key = kind+'|'+(ev.type || '');
    ...
    ['pointerdown','touchstart','mousedown'].forEach(function(type){
      document.addEventListener(type, previewNativeTab, {capture:true, passive:true});
    });
